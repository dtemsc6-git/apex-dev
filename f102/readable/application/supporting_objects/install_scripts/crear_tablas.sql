  ...
  CREATE TABLE "SGT_ARCHIVOS" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
	...
	"INTERNAL_ATTR" VARCHAR2(255) DEFAULT 'nuevo'
   ) ;
  ...
  CREATE TABLE "SGT_ENLACES_FO" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
	...
	"LT" VARCHAR2(50) NOT NULL ENABLE, 
	...
	"PUERTOS_LADO_B" VARCHAR2(255), 
	 PRIMARY KEY ("ID")
  USING INDEX  ENABLE, 
	 CONSTRAINT "CHK_ENLACES_FO_ESTADO" CHECK (ESTADO IN ('Activo', 'Cortado', 'Suprimido / Retirado', 'Desconocido', 'Planificado')) ENABLE
   ) ;
  ...
  CREATE TABLE "SGT_ENLACES_WAN" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
	"NOMBRE" VARCHAR2(255) NOT NULL ENABLE, 
	"GRUPO_RED" VARCHAR2(1000) NOT NULL DISABLE, 
	"CREADO_POR" VARCHAR2(255), 
	"CREADO_EL" TIMESTAMP (6), 
	"ACTUALIZADO_POR" VARCHAR2(255), 
	"ACTUALIZADO_EL" TIMESTAMP (6), 
	"TIPO_WAN_ID" NUMBER NOT NULL ENABLE, 
	 PRIMARY KEY ("ID")
  USING INDEX  ENABLE, 
  ...
  CREATE TABLE "SGT_EQUIPOS_SERVICIO" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
	"SERVICIO_ID" NUMBER, 
	"WAN_ID" NUMBER, 
	"EQUIPO_A_ID" NUMBER, 
  ...
  CREATE TABLE "SGT_SITIOS" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
	...
	"ZONA_ID" NUMBER, 
	"CIUDAD_ID" NUMBER, 
	"LATITUD_OLD" VARCHAR2(50), 
	"LONGITUD_OLD" VARCHAR2(50), 
  ...
  CREATE TABLE "SGT_SITIOS_ARCHIVOS" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
	"ARCHIVO_ID" NUMBER, 
	"SITIO_ID" NUMBER
   ) ;
  ...
  CREATE TABLE "SGT_TIPO_INTERFAZ" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
	"NOMBRE" VARCHAR2(64 CHAR) NOT NULL ENABLE, 
	"DESCRIPCION" VARCHAR2(1000 CHAR), 
	 PRIMARY KEY ("ID")
  USING INDEX  ENABLE
   ) ;

  CREATE TABLE "SGT_TIPO_WAN" 
   (	"ID" NUMBER GENERATED BY DEFAULT ON NULL AS IDENTITY MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 NOORDER  NOCYCLE  NOKEEP  NOSCALE  NOT NULL ENABLE, 
	"NOMBRE" VARCHAR2(255) NOT NULL ENABLE, 
	"CREADO_POR" VARCHAR2(255), 
	"CREADO_EL" TIMESTAMP (6), 
  ...
  CREATE OR REPLACE EDITIONABLE TRIGGER "TRG_TEST_ARCHIVOS_OBSOLETO" 
before
insert or update or delete on "SGT_ARCHIVOS"
for each row
begin
    if (:NEW.estado = 2) then
       :NEW.internal_attr := 'obsoleto';
    end if;   
end;
/
ALTER TRIGGER "TRG_TEST_ARCHIVOS_OBSOLETO" ENABLE;
  CREATE OR REPLACE EDITIONABLE TRIGGER "TRG_ST_ARCHIVOS" 
before
insert or update ON "SGT_ARCHIVOS"
for each row
begin
    --
    --actualizar info de  
...
/
ALTER TRIGGER "TRG_ST_ARCHIVOS" ENABLE;

  CREATE OR REPLACE EDITIONABLE TRIGGER "TRG_ST_COMENTARIOS" 
BEFORE
insert or update on "SGT_COMENTARIOS"
for each row
begin
--    --actualizar info de  
    IF INSERTING THEN 
...
/
ALTER TRIGGER "TRG_ST_COMENTARIOS" ENABLE;

  CREATE OR REPLACE EDITIONABLE TRIGGER "TRG_ST_TIPO_WAN" 
before
insert or update ON "SGT_TIPO_WAN"
for each row
begin
    --
    --actualizar info de  
...
/
ALTER TRIGGER "TRG_ST_TIPO_WAN" ENABLE;
  ...
  CREATE INDEX "IDX_CUIDAD_DEPTO" ON "SGT_CIUDAD" ("DEPTO_ID") 
  ;
...
ALTER TRIGGER "TRG_AUDIT_SGT_ENLACES_TRAMOS" ENABLE;
  ...
  ALTER TABLE "SGT_ENLACES_WAN" ADD CONSTRAINT "ENLACES_WAN_FK_TIPO_WAN_ID" FOREIGN KEY ("TIPO_WAN_ID")
	  REFERENCES "SGT_TIPO_WAN" ("ID") ENABLE;
...
ALTER TRIGGER "TRG_AUDIT_SGT_EQUIPOS" ENABLE;
  CREATE OR REPLACE EDITIONABLE TRIGGER "TRG_EQUIPOS_VALIDAR_U" 
...
/
ALTER TRIGGER "TRG_EQUIPOS_VALIDAR_U" ENABLE;
...
ALTER TRIGGER "TRG_AUDIT_SGT_RACKS" ENABLE;
  CREATE OR REPLACE EDITIONABLE TRIGGER "TRG_RACKS_VALIDAR_ALTURA_U" 
before
...
/
ALTER TRIGGER "TRG_RACKS_VALIDAR_ALTURA_U" ENABLE;
...
ALTER TRIGGER "TRG_ST_SGT_IP_ADM" ENABLE;
  ...
  ALTER TABLE "SGT_EQUIPOS_SERVICIO" ADD CONSTRAINT "SGT_EQUIPOS_SERVICIO_FK_SERV" FOREIGN KEY ("SERVICIO_ID")
	  REFERENCES "SGT_SERVICIOS" ("ID") ENABLE;
  ALTER TABLE "SGT_EQUIPOS_SERVICIO" ADD CONSTRAINT "SGT_EQUIPOS_SERVICIO_FK_WAN" FOREIGN KEY ("WAN_ID")
	  REFERENCES "SGT_ENLACES_WAN" ("ID") ENABLE;
  ALTER TABLE "SGT_EQUIPOS_SERVICIO" ADD CONSTRAINT "SGT_EQUIPOS_SERVICIO_FK_EQUIPO_A" FOREIGN KEY ("EQUIPO_A_ID")
	  REFERENCES "SGT_EQUIPOS" ("ID") ENABLE;
  ALTER TABLE "SGT_EQUIPOS_SERVICIO" ADD CONSTRAINT "SGT_EQUIPOS_SERVICIO_FK_IFACE_A" FOREIGN KEY ("INTERFAZ_A_ID")
	  REFERENCES "SGT_INTERFACES" ("ID") ENABLE;
  ALTER TABLE "SGT_EQUIPOS_SERVICIO" ADD CONSTRAINT "SGT_EQUIPOS_SERVICIO_FK_EQUIPO_B" FOREIGN KEY ("EQUIPO_B_ID")
	  REFERENCES "SGT_EQUIPOS" ("ID") ENABLE;
  ALTER TABLE "SGT_EQUIPOS_SERVICIO" ADD CONSTRAINT "SGT_EQUIPOS_SERVICIO_FK_IFACE_B" FOREIGN KEY ("INTERFAZ_B_ID")
	  REFERENCES "SGT_INTERFACES" ("ID") ENABLE;
  ALTER TABLE "SGT_EQUIPOS_SERVICIO" ADD CONSTRAINT "SGT_EQUIPOS_SERVICIO_FK_FO" FOREIGN KEY ("FO_ID")
	  REFERENCES "SGT_ENLACES_FO" ("ID") ENABLE;

  CREATE OR REPLACE EDITIONABLE TRIGGER "TRG_ST_EQUIPOS_SERVICIO" 
before
insert or update  on "SGT_EQUIPOS_SERVICIO"
for each row
begin
     --actualizar info de  
    IF INSERTING THEN 
        ...
        :NEW.modificado_POR := nvl(wwv_flow.g_user,user); 
    ELSIF UPDATING THEN 
        :NEW.modificado_el := SYSDATE; 
        :NEW.modificado_POR := nvl(wwv_flow.g_user,user); 
    END IF; 
...
/
ALTER TRIGGER "TRG_ST_EQUIPOS_SERVICIO" ENABLE;

  ALTER TABLE "SGT_EQUIPOS_WAN" ADD CONSTRAINT "EQUIPOS_WAN_FK_PARENT_WAN_ID" FOREIGN KEY ("PARENT_WAN_ID")
	  REFERENCES "SGT_ENLACES_WAN" ("ID") ENABLE;
  ALTER TABLE "SGT_EQUIPOS_WAN" ADD CONSTRAINT "SGT_EQUIPOS_WAN_FK_WAN" FOREIGN KEY ("WAN_ID")
	  REFERENCES "SGT_ENLACES_WAN" ("ID") ENABLE;
  ALTER TABLE "SGT_EQUIPOS_WAN" ADD CONSTRAINT "SGT_EQUIPOS_WAN_FK_EQUIPO_A" FOREIGN KEY ("EQUIPO_A_ID")
	  REFERENCES "SGT_EQUIPOS" ("ID") ENABLE;
  ALTER TABLE "SGT_EQUIPOS_WAN" ADD CONSTRAINT "SGT_EQUIPOS_WAN_FK_IFACE" FOREIGN KEY ("INTERFAZ_A_ID")
	  REFERENCES "SGT_INTERFACES" ("ID") ENABLE;
  ALTER TABLE "SGT_EQUIPOS_WAN" ADD CONSTRAINT "SGT_EQUIPOS_WAN_FK_EQUIPO_B" FOREIGN KEY ("EQUIPO_B_ID")
	  REFERENCES "SGT_EQUIPOS" ("ID") ENABLE;
  ALTER TABLE "SGT_EQUIPOS_WAN" ADD CONSTRAINT "SGT_EQUIPOS_WAN_FK_IFACE_B" FOREIGN KEY ("INTERFAZ_B_ID")
	  REFERENCES "SGT_INTERFACES" ("ID") ENABLE;
  ALTER TABLE "SGT_EQUIPOS_WAN" ADD CONSTRAINT "SGT_EQUIPOS_WAN_FK_FO" FOREIGN KEY ("FO_ID")
	  REFERENCES "SGT_ENLACES_FO" ("ID") ENABLE;

  CREATE OR REPLACE EDITIONABLE TRIGGER "TRG_ST_EQUIPOS_WAN" 
before
insert or update on "SGT_EQUIPOS_WAN"
for each row
begin
    --actualizar info de  
    IF INSERTING THEN 
...
/
ALTER TRIGGER "TRG_ST_EQUIPOS_WAN" ENABLE;

   CREATE SEQUENCE  "AUDIT_DETAIL_SEQ"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 2012857 NOCACHE  NOORDER  NOCYCLE  NOKEEP  NOSCALE  GLOBAL ;